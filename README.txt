...
Шаги:
    В настоящий момент можно использовать следующие шаги (в независимости от этапа Дано/Когда/Тогда/И):
        ...
        элемент "<element_type>" с текстом "<element_text>" должен быть отображен
        элемент "<element_type>" с текстом "<element_text>" должен быть отображен на странице 'ОК'
        элемент "<element_type>" с текстом "<element_text>" должен быть отображен на странице 'Ошибка'
        ...
        в логе сервера должна присутствовать строка "<text>"
        в логе клиента должна присутствовать строка "<text>"
        в логе эмулятора должна присутствовать строка "<text>"
